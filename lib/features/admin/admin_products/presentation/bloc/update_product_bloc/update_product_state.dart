...
class UpdateProductState with _$UpdateProductState {
  ...
  const factory UpdateProductState.getProductLoading() = GetProductLoadingState;
  const factory UpdateProductState.getProductSuccess(
      {required ProductResponseModel body}) = GetProductSuccessState;
